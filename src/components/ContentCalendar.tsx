...
export const ContentCalendar = () => {
  ...
  const renderCalendarCell = (date: Date) => {
    ...
    const savedEvents = dayEvents.filter(e => e.is_saved);
    ...
    return (
      <div className="relative w-full h-full">
        ...
        {dayEvents.length > savedEvents.length && (
                  ...
                  <Card className="p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border-0">
                    ...
                    <div className="space-y-3">
                      ...
                      {getEventsForDate(selectedDate).map((event) => (
                        <div 
                          key={event.id} 
                          className="p-3 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl border border-blue-200 cursor-pointer hover:from-blue-100 hover:to-blue-150 transition-colors"
                      ...
                      {getImportantDatesForDate(selectedDate).length === 0 && getEventsForDate(selectedDate).length === 0 && (
